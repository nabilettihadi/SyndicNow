    ...
    <footer class="bg-gray-900 text-gray-300">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div class="space-y-4">
            <h3 class="text-lg font-semibold text-white">SyndicNow</h3>
            <p class="text-sm">Making property management easier and more efficient for everyone.</p>
        ...
        <div class="mt-12 pt-8 border-t border-gray-800">
          <div class="flex flex-col md:flex-row justify-between items-center">
            <p class="text-sm">&copy; 2025 SyndicNow. All rights reserved.</p>
            <div class="mt-4 md:mt-0">
              <p class="text-sm">Contact: contact&#64;syndicnow.com</p>
            </div>
          </div>
        </div>
      </div>
